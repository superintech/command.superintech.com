  ...
  return (
    <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))] hover:border-[hsl(var(--layout-border))] transition-colors">
      <CardContent className="p-6">
        ...
        <div className="mt-4 h-2 rounded-full bg-[hsl(var(--layout-card-hover))]">
          <div
          ...
          <div className="mt-3 space-y-1">
            {entry.tasks.slice(0, 3).map((task, idx) => (
              <div key={idx} className="text-xs text-[hsl(var(--text-primary))] truncate">
                ...
                <span className="text-[hsl(var(--text-muted))] ml-1">({task.hours.toFixed(1)}h)</span>
                {task.pendingItems && (
      ...
      <Tabs defaultValue={userIsManager ? "eodr-table" : "my-kpi"}>
                      ...
                      <table className="w-full">
                        ...
                        <tbody>
                          {teamDaily.team.map((member) => (
                            <tr
                              key={member.user.id}
                              className={`border-b border-[hsl(var(--layout-border))] hover:bg-[hsl(var(--layout-card-hover))]/30 ${
        ...
        <TabsContent value="employee-of-month" className="space-y-6">
          ...
          {loadingEOM ? (
            ...
            <>
              ...
              <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
                ...
                <CardContent>
                  ...
                  <p className="mt-4 text-xs text-[hsl(var(--text-muted))] italic">
            ...
            <Card className="!bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
              <CardContent className="flex flex-col items-center justify-center py-12">
                <Trophy className="h-12 w-12 text-[hsl(var(--text-muted))]" />
      ...
      <Dialog open={!!reviewingEntry} onOpenChange={() => setReviewingEntry(null)}>
        <DialogContent className="max-w-lg bg-[hsl(var(--layout-card))] border-[hsl(var(--layout-border))]">
          ...
          <DialogFooter className="flex gap-2">
            <Button variant="outline" onClick={() => setReviewingEntry(null)} className="border-[hsl(var(--layout-border))] text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]">
              Cancel
            </Button>
            <Button
              variant="outline"
              ...
              className="border-[hsl(var(--layout-border))] text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]"
            >
              Save Only
            </Button>
            <Button
          ...
          {scoringMember && (
            <div className="space-y-4 pr-2">
              ...
              <div className="bg-blue-500/10 p-3 rounded text-center border border-blue-500/30">
                ...
                <p className="text-xs text-[hsl(var(--text-muted))]">Baseline: 4 (1 per metric) • Above 4 = Exceptional</p>
              </div>
            </div>
          )}
          <DialogFooter>
            <Button variant="outline" onClick={() => setScoringMember(null)} className="border-[hsl(var(--layout-border))] text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--layout-card-hover))]">
              Cancel
            </Button>
            <Button
